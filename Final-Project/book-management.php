...
<body>
    <div id="main-content">
        ...
        <div id="isi">
            <h1>Data Buku</h1>
            <button data-target="#create" data-toggle="modal" style="background-color: #9a1f40;" class="btn btn-primary btn-lg btn-block">Input Buku Baru</button><br>
            <form action="galeri.php" method="post">
                <input type="text" placeholder="Search Keyword.." name="katakunci" id="mySearch">
                <select style="width: 30%;height: 40px;border:solid 1px lightgrey;margin-top:-25px; font-size: 15px;" name="option">
                ...
                <select style="width: 30%;height: 40px;border:solid 1px lightgrey; font-size: 15px;" name="sort">
                    <option value="id_buku">None..</option>
                    <option value="judul">Alfabet</option>
                    <option value="tahun">Tahun</option>
                </select>
                <select style="width: 30%;height: 40px;border:solid 1px lightgrey; font-size: 15px;" name="order">
                    <option value="ASC">Ascending</option>
                    <option value="DESC">Descending</option>
                </select>
                <button type="submit" class="button" name="filter">Cari!</button>
            </form>
